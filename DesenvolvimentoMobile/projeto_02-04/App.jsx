...
import {View, Text, TextInput, Button, Switch, StyleSheet, Platform} from "react-native";
...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Cadastro Banco</Text>
      ...
      <Text style={styles.label}>Escolha seu Limite: {limite.toFixed(2)} R$</Text>
      <Slider
        minimumValue={100}
        maximumValue={5000}
        step={100}
